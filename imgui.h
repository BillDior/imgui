...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_AlignToMiddle = 1 << 22, // Edit(Yuchen Liu): add a flag to allow numbers to align to middle of context box
    ImGuiInputTextFlags_CharsNoSymbol = 1 << 23  // Edit(Yuchen Liu): add a flag to allow 0123456789ABC..Zabc..z
